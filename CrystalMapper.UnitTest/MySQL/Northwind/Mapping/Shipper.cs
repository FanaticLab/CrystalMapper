...
namespace CrystalMapper.UnitTest.MySQL.Northwind
{
    ...
    {		
		...
		private const string SQL_INSERT_SHIPPERS = "INSERT INTO shippers (CompanyName, Phone) VALUES ( @CompanyName, @Phone);"   + " SELECT LAST_INSERT_ID();" ;
		
		private const string SQL_UPDATE_SHIPPERS = "UPDATE shippers SETCompanyName = @CompanyName, Phone = @Phone WHERE ShipperID = @ShipperID";
