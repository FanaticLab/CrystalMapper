...
namespace CrystalMapper.UnitTest.SQL.Northwind
{
    ...
    {		
		...
		private const string SQL_UPDATE_CATEGORIES = "UPDATE dbo.Categories SETCategoryName = @CategoryName, Description = @Description, Picture = @Picture WHERE CategoryID = @CategoryID";
