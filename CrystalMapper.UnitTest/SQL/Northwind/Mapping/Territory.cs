...
namespace CrystalMapper.UnitTest.SQL.Northwind
{
    ...
    {		
		...
		private const string SQL_UPDATE_TERRITORIES = "UPDATE dbo.Territories SETTerritoryDescription = @TerritoryDescription, RegionID = @RegionID WHERE TerritoryID = @TerritoryID";
