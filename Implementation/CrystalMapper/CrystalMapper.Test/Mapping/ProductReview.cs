 ...
 * 
 * Date:  Friday, June 05, 2009 3:11 PM
 * 
 * Class: ProductReview
 *    
 */
...
namespace CrystalMapper.Generated.BusinessObjects
{
    ...
    public partial class ProductReview : Entity<ProductReview>
    {
        ...
        private const string SQL_INSERT_PRODUCTREVIEW = "INSERT INTO Production.ProductReview(ProductReviewID,ProductID,ReviewerName,ReviewDate,EmailAddress,Rating,Comments,ModifiedDate) VALUES (@ProductReviewID,@ProductID,@ReviewerName,@ReviewDate,@EmailAddress,@Rating,@Comments,@ModifiedDate)";
        ...
        [Column(COL_PRODUCTREVIEWID, PARAM_PRODUCTREVIEWID)]
