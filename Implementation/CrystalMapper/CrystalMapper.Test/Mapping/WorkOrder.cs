 ...
 * 
 * Date:  Friday, June 05, 2009 2:51 PM
 * 
 * Class: WorkOrder
 *    
 */
...
namespace CrystalMapper.Generated.BusinessObjects
{
    ...
    public partial class WorkOrder : Entity<WorkOrder>
    {
        ...
        private const string SQL_INSERT_WORKORDER = "INSERT INTO Production.WorkOrder(WorkOrderID,ProductID,OrderQty,StockedQty,ScrappedQty,StartDate,EndDate,DueDate,ScrapReasonID,ModifiedDate) VALUES (@WorkOrderID,@ProductID,@OrderQty,@StockedQty,@ScrappedQty,@StartDate,@EndDate,@DueDate,@ScrapReasonID,@ModifiedDate)";
        ...
        [Column(COL_WORKORDERID, PARAM_WORKORDERID)]
        public virtual int WorkOrderID { get; set; }

        [Column(COL_PRODUCTID, PARAM_PRODUCTID)]
        public virtual int ProductID { get; set; }
        [Column(COL_ORDERQTY, PARAM_ORDERQTY)]
        public virtual int OrderQty { get; set; }
        [Column(COL_STOCKEDQTY, PARAM_STOCKEDQTY)]
        public virtual int StockedQty { get; set; }
        [Column(COL_SCRAPPEDQTY, PARAM_SCRAPPEDQTY)]
        public virtual short ScrappedQty { get; set; }
        [Column(COL_STARTDATE, PARAM_STARTDATE)]
        public virtual System.DateTime StartDate { get; set; }
        [Column(COL_ENDDATE, PARAM_ENDDATE)]
        public virtual System.DateTime? EndDate { get; set; }
        [Column(COL_DUEDATE, PARAM_DUEDATE)]
        ...
        [Column(COL_MODIFIEDDATE, PARAM_MODIFIEDDATE)]
